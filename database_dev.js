...
Common,SI:deltaK=TEMP #interval (T-T0) Kelvin
*Common,Angle:radian*,radian=1
...
*Common,SI:weber*,weber=1 volt second
...
DERIVED Density=kgramm per liter
DERIVED Flow=liter per second
DERIVED Heat_latent_m=joule per kgramm
AMBIGUOUS Heat_latent_v=joule per liter
DERIVED Specific_heat_m=joule per (kgramm*deltaK)
DERIVED Specific_heat_v=joule per (liter*deltaK)
AMBIGUOUS Heat_vaporization_m=joule per kgramm
AMBIGUOUS Heat_vaporization_v=joule per liter
AMBIGUOUS Heat_fusion_m=joule per kgramm
...
DERIVED Line_density=kgramm per meter
DERIVED Kinematic_viscosity=meter^2 per second
AMBIGUOUS Heat_combustion_m=joule per kgramm
AMBIGUOUS Heat_combustion_v=joule per liter
DERIVED Fuel_efficiency=kmeter per liter
DERIVED Momentum=kgramm meter per second
